...
-- Create instagramUserProfile table
...
-- Add foreign key constraint to instagramUserInteraction table
ALTER TABLE instagramUserInteraction
ADD CONSTRAINT fk_instagram_scoped_id
