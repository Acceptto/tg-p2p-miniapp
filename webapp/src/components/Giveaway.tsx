		...
		<Card className="w-full bg-white dark:bg-gray-900 shadow-lg border border-gray-200 dark:border-gray-700 mx-auto max-w-sm sm:max-w-md">
			...
			<CardContent className="space-y-4 sm:space-y-6">
				...
				<div className="text-center">
					<p className="text-sm sm:text-lg font-light text-gray-600 dark:text-gray-300">
						Win a serene escape to our minimalist resort 🏝️
					</p>
				</div>
				<div className="space-y-3 sm:space-y-4">
					<h3 className="font-light text-lg sm:text-xl text-center text-gray-800 dark:text-gray-200">
						Prizes
					</h3>
					<div className="grid grid-cols-1 gap-2 sm:gap-3">
						<div className="p-2 sm:p-3 rounded-md bg-gray-100 dark:bg-gray-800 flex items-center">
							<Hotel className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 text-blue-600 dark:text-blue-400" />
							<p className="text-sm sm:text-base font-medium text-gray-800 dark:text-gray-200">
								3-Night Zen Retreat 🧘‍♀️
							</p>
						</div>
						<div className="p-2 sm:p-3 rounded-md bg-gray-100 dark:bg-gray-800 flex items-center">
							<Plane className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 text-blue-600 dark:text-blue-400" />
							<p className="text-sm sm:text-base font-medium text-gray-800 dark:text-gray-200">
								Eco-Friendly Travel Kit 🌿
							</p>
						</div>
						<div className="p-2 sm:p-3 rounded-md bg-gray-100 dark:bg-gray-800 flex items-center">
							<Clock className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 text-blue-600 dark:text-blue-400" />
							<p className="text-sm sm:text-base font-medium text-gray-800 dark:text-gray-200">
